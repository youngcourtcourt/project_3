...
# explode = [.5,.25,.25,-.5,0,0,0,0,0]
    ...
    plt.savefig("static/visualizations/Percentage_of_Total_Waveform_Pie_Chart.png", )
    plt.show()
    ...
    data = predicition_data["Match"].value_counts()
    labels = predicition_data["Match"]
    labels = labels.unique()



    plt.pie(data, labels=labels)
    plt.savefig("static/visualizations/True_False_Prediction_Count.png")
    plt.plot()
...
# setup the figure
    ...
    plt.savefig("static/visualizations/Correct_vs_Incorrect_Over_Depth_and_Magnitude.png")
    plt.show()
